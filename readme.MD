...
This module is going to create the following resources. For HA, we are going to get first 2 AZ's.                           
* VPC
* Internet Gateway associated with VPC
* 2 Public Subnets, one in each AZ
* 2 Private Subnets, one in each AZ
* 2 Database Subnets, one in each AZ
* Database subnet group
* EIP (Elastic Internet IP)
* NAT Gateway
* Public Route table
* Private Route table
...
* Peering routes in both accepter and requester route tables.
